#!/usr/bin/env bash
# ============================================================
#  Crypto Quest Telegram Bot — interactive server installer
#  ------------------------------------------------------------
...
ENV_FILE="$ROOT/.env"
cat > "$ENV_FILE" <<EOF
# Crypto Quest Bot — configuration (generated by deploy_server.sh)
# This .env was built from the answers you gave during install.
# You can edit it later and run: systemctl restart crypto-quest-bot
